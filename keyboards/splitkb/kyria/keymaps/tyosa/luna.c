...
void render_luna(int LUNA_X, int LUNA_Y) {
    // Sit
    static const char PROGMEM sit[2][3][ANIM_SIZE / 3] = {// 'sit1', 32x22px
    ...
    // Walk
    static const char PROGMEM walk[2][3][ANIM_SIZE / 3] = {// 'walk1', 32x22px
    ...
    // Run
    static const char PROGMEM run[2][3][ANIM_SIZE / 3] = {// 'run1', 32x22px
    ...
    // Bark
    static const char PROGMEM bark[2][3][ANIM_SIZE / 3] = {// 'bark1', 32x22px
    ...
    // Sneak
    static const char PROGMEM sneak[2][3][ANIM_SIZE / 3] = {// 'sneak1', 32x22px

...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_COLEMAK_DH] = LAYOUT(
               GAME,  Q_CAPS,    KC_W, F_SEARC,    KC_P,    KC_B,                                        KC_J,    L_FF,    KC_U,    KC_Y, KC_SCLN, XXXXXXX,
    ...
    [_GAME] = LAYOUT(
               KC_1,     KC_2,    KC_3,    KC_4,    KC_5,    KC_6,                                     KC_ASTR,    KC_7,    KC_8,    KC_9, KC_MINS, XXXXXXX,
               KC_7,     KC_8,    KC_9,   KC_UP,    KC_E,    KC_F,                                      KC_DOT,   HR_S4,   HR_C5,   HR_A6,  HR_GEQ, XXXXXXX,
            COLEMAK,     KC_Q, KC_LEFT, KC_DOWN, KC_RGHT, XXXXXXX, COLEMAK, KC_LENC, KC_RENC,     NAV,    KC_0,    KC_1,    KC_2,    KC_3,     NAV,  KC_DEL,
                                       _______,  KC_BTN2,  KC_LSFT,  KC_SPC, KC_LCTL,  KC_ENT, KC_BSPC,     SYM, XXXXXXX, XXXXXXX
            ),
};
